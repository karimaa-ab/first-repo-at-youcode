...
let mensualite = montantEmprunte / dureeEnMois; // 100000 / 24 = 4166.666666666667
let limiteMensualite = revenuMensuel * 0.30; // 30% de 8000 =  8000 * 0.30 = 2400

if (mensualite <= limiteMensualite) {
    console.log(`Prêt accordé. Mensualité : ${mensualite} MAD`);
} else {
    if (revenuMensuel > 10000 && mensualite > limiteMensualite) {
        console.log("Prêt refusé. Proposez d'augmenter la durée.");
    } else {
        console.log("Prêt refusé");
    }
} // 4166.666666666667 > 2400, donc le prêt est refusé. Le revenu n'est pas > 10000, donc "Prêt refusé".