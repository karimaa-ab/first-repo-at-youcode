 ...
 *
 * 🎯 MISSION
 * Écrivez une fonction qui prend un tableau avec des doublons [1, 2, 2, 3, 4, 4, 5] et 
...
let tableau = [1, 2, 2,2, 3, 4, 4, 5,];

function doublons(tableau) {
    let newTab = [];
    for (let i = 0; i < tableau.length; i++) {
        if (!newTab.includes(tableau[i])) {
...
console.log(doublons(tableau)); // [1,2,3,4,5]
